...
class BertModel(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        input_mask = tf.cast(inputs[1], tf.int32)
        token_type_ids = tf.cast(inputs[2], tf.int32)
        ...
        self.embedding_output = self.embedding_lookup(input_ids)
        ...
        self.all_encoder_layers = self.transformer_model(self.embedding_output,
...
class embedding_lookup(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        '''
        # print("input : ",inputs, inputs.shape,inputs.shape.ndims)
        if inputs.shape.ndims == 2:
            inputs = tf.expand_dims(inputs, axis=[-1])

        # print("input : ", inputs.shape, inputs.shape.ndims)
